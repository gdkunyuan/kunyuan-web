  ...
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        logo: '新能源',
        tags: ['财务规范', '税务筹划', '风险防控'],
        challenge: '公司业务快速扩张，但财务管理基础薄弱，存在核算不规范、税务风险高、内控体系缺失等问题。近年因税务处理不当被税务机关处罚，财务报表数据质量不高，影响企业融资和经营决策。',
        solution: '坤元财务团队提供"财务规范化提升"全案服务：① 按照会计准则重构财务核算体系，规范收入确认、成本归集和费用分摊；② 开展全面税务健康体检，识别历史税务风险点，制定整改方案，优化税务筹划策略；③ 建立财务内控制度，规范审批流程和权限管理；④ 搭建财务分析体系，提供经营决策支持。',
        result: '项目推进12个月，财务核算规范化率从60%提升至95%，税务风险隐患全部整改完成，未再发生税务处罚。财务数据质量显著提升，为企业后续融资和业务拓展奠定了坚实基础。',
        timeframe: '2023年8月 - 2024年8月',
        quote: '坤元帮我们从根本上解决了财务规范问题，现在我们的财务数据真实可靠，企业管理也更有底气了。',
        quoteBy: '总经理 陈先生'
      }
    ]
  },
